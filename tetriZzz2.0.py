...
base_blocos = 10
altura_blocos = 16
altura = tamanho_bloco * altura_blocos
largura = tamanho_bloco * base_blocos
mapa = []
linha_vazia = []
random = SystemRandom()
pygame.font.init()
...
janela, fonte_texto = eng.criar_janela(largura, altura)
    ...
    for linhas in range(len(mapa)):
        for colunas in range(len(mapa[linhas])):
            ...
            if mapa[linhas][colunas] == 1:
                pygame.draw.rect(janela, [0,255,10], block)
            elif mapa[linhas][colunas] == 2:
                pygame.draw.rect(janela, [255,0,0], block)
            elif mapa[linhas][colunas] == 3:
                pygame.draw.rect(janela, [255,0,255], block)
            elif mapa[linhas][colunas] == 4:
                pygame.draw.rect(janela, [25,255,255], block)
            elif mapa[linhas][colunas] == 5:
                pygame.draw.rect(janela, [255,255,0], block)
            elif mapa[linhas][colunas] == 6:
                pygame.draw.rect(janela, [255,100,0], block)
            elif mapa[linhas][colunas] == 7:
                pygame.draw.rect(janela, [100,50,255], block)
