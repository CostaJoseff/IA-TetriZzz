...
class TetriZzz_Otimizado:
  def __init__(self):
    ...
    self.engine = engine.Engine(self.largura, self.altura, self.base_blocos)
    self.game_loop()
  ...
  def game_loop(self):
    while self.executando:
      ...
      if self.isA and pecas.espaco_esquerda(self.matriz, self.vetor2[0], self.vetor2[1], self.peca_atual, self.rotacao_atual):
        self.remover_blocos()
